 ...
 * 
 */
@WebServiceClient(name = "webserviceImplService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:9001/test/soapwebservice?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9001/test/soapwebservice?wsdl");
